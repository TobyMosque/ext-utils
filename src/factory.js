 ...
 * @param {Object} param - the page properties (`mounted`, `computed`, `etc`)
 ...
 * @param {String} param.options.privatePrefix - the prefix of the private fields used by the getters and setters
...
const store = function ({ options, initialize, ...store }) {
  ...
  if (options && options.model) {
    model = {
      ...
      mutations: mapStoreMutations(options.model, options.privatePrefix)
    }
  }
 ...
 * @param {CollectionItem[]} param.options.collections - an array of objects that describes your collection
 * @param {String} param.options.privatePrefix - the prefix of the private fields used by the getters and setters
 * @param {Object} param.storeModule - if not null, it'll be registered in the preFetch or in the mounted hook, and removed in the destroyed hook.
...
const page = function ({ options, storeModule, moduleName, ...page }) {
  ...
  if (options && options.model) {
    ...
    let prefix = options.privatePrefix
    if (prefix) {
